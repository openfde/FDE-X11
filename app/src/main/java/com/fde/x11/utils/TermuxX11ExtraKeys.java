...
import static com.fde.shared.termux.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.fde.x11.MainActivity.toggleKeyboardVisibility;
...
import com.fde.shared.termux.extrakeys.*;
import com.fde.x11.LoriePreferences;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.fde.x11.start_preferences_activity";
